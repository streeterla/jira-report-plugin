...
<textarea name="<webwork:property value="parameters['name']"/>"
          ...
          wrap="virtual"
          <webwork:property value="parameters['style']">  <%-- by default, text areas have a width of 90% --%>
            <webwork:if test=".">style="<webwork:property value="."/>"</webwork:if>
            <webwork:else >style="width:90%"</webwork:else>
         </webwork:property>
         <webwork:property value="parameters['disabled']">
            <webwork:if test="{parameters['disabled']}">DISABLED</webwork:if>
         </webwork:property>
         <webwork:property value="parameters['accesskey']">
            <webwork:if test=".">accesskey="<webwork:property value="." />"</webwork:if>
         </webwork:property>
...
><webwork:property value="parameters['nameValue']" escape="true"/></textarea>
