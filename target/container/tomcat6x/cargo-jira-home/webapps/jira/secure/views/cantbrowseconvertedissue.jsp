...
<html>
<head>
    <title><webwork:text name="'createissue.cant.browse.converted.issue.title'"/></title>
    <meta name="decorator" content="notitle">
</head>
<body>
    <page:applyDecorator name="jirapanel">
        <page:param name="title"><webwork:text name="'createissue.cant.browse.converted.issue.title'"/></page:param>

        <webwork:text name="'createissue.cant.browse.converted.issue.description'">
