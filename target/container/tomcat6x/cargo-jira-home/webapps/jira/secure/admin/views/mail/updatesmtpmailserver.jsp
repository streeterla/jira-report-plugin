...
<html>
<head>
	<title><webwork:text name="'admin.mailservers.update.smtp.mail.server'"/></title>
</head>
...
<body>
    ...
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="title"><webwork:text name="'admin.mailservers.update.smtp.mail.server'"/></page:param>
        <page:param name="description"><webwork:text name="'admin.mailservers.update.description'"/></page:param>
