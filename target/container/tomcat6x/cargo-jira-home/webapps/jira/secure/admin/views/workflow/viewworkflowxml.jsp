<%@ taglib uri="webwork" prefix="webwork" %><%@ page import="com.atlassian.jira.ComponentManager"%><%@ page import="webwork.util.ValueStack" %><%@ page import="com.atlassian.jira.issue.views.util.WordViewUtils" %><%
...
%><webwork:property value="xml" escape="false" />
