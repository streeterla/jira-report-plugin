...
<html>
<head>
	<title><webwork:text name="'admin.issuefields.screens.delete'"/></title>
</head>
<body>
    <p>
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="title"><webwork:text name="'admin.issuefields.screens.delete'"/></page:param>
        <page:param name="width">100%</page:param>
        <page:param name="description">
            <p>
                <webwork:text name="'admin.issuefields.screens.confirm.delete'">
