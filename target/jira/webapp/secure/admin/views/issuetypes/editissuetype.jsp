...
<html>
<head>
    <title><webwork:text name="'admin.issuesettings.issuetypes.edit.issue.type'"/></title>
</head>
<body>
<script language="JavaScript">
    ...
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="title"><webwork:text name="'admin.issuesettings.issuetypes.edit.issue.type'"/>: <webwork:property value="constant/string('name')" /></page:param>
