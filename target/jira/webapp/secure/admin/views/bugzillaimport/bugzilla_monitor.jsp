...
<html>
<head>
    <title><webwork:text name="'admin.externalimport.bugzilla.log.watcher'"/></title>
...
<page:applyDecorator name="jiraform">
    ...
    <page:param name="title"><webwork:text name="'admin.externalimport.bugzilla.import.progress'"/></page:param>
    <page:param name="width">100%</page:param>
    <page:param name="description">
      <webwork:text name="'admin.externalimport.bugzilla.import.progress.description'"/>
