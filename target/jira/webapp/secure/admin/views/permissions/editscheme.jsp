...
<html>
<head>
	<title><webwork:text name="'admin.schemes.permissions.edit.permission.scheme'"/></title>
</head>
...
<body>
    ...
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="title"><webwork:text name="'admin.schemes.permissions.edit.permission.scheme'"/>: <webwork:property value="scheme/string('name')" /></page:param>
