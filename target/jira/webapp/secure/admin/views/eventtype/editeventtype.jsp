...
<html>
<head>
	<title><webwork:text name="'admin.event.types.edit'"/></title>
</head>
...
<body>
    ...
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="title"><webwork:text name="'admin.event.types.edit'"/></page:param>
        <page:param name="width">100%</page:param>
        <page:param name="description">
            <p>
                <webwork:text name="'admin.event.types.edit.desc'">
                    <webwork:param><b></webwork:param>
                    <webwork:param><webwork:property value="/eventTypeManager/eventType(eventTypeId)/name"/></webwork:param>
                    <webwork:param></b></webwork:param>
                </webwork:text>
            </p>
        </page:param>

        <webwork:property value="/eventTypeManager/eventType(eventTypeId)">
