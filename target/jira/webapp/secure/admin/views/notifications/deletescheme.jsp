...
<html>
<head>
	<title><webwork:text name="'admin.schemes.notifications.delete.notification.scheme'"/></title>
</head>
...
<body>
    ...
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="title"><webwork:text name="'admin.schemes.notifications.delete.notification.scheme'"/></page:param>
        ...
        <webwork:if test="projects(scheme)/size > 0" >
            <p><webwork:text name="'admin.schemes.delete.warning'">
                <webwork:param name="'value0'"><font color=#cc0000></webwork:param>
                <webwork:param name="'value1'"><u><webwork:property value="name" /></u></webwork:param>
            </webwork:text>
            ...
            <webwork:text name="'admin.schemes.notifications.delete.may.wish.to.delete.another'"/></font></p>
        </webwork:if>
