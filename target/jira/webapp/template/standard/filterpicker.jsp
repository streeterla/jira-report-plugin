...
<span id="filter_<webwork:property value="parameters['name']"/>_name"><webwork:property value="parameters['filtername']"/></span>
<a href="#" id="filter_<webwork:property value="parameters['name']"/>_button" onclick="window.open('<%= request.getContextPath() %>/secure/FilterPickerPopup.jspa?field=<webwork:property value="parameters['name']"/>','filter_<webwork:property value="parameters['name']"/>_window', 'width=800, height=500, resizable, scrollbars=yes').focus(); return false;">
    <webwork:if test="parameters['value'] == null || parameters['value'] == ''">
        <webwork:text name="'popups.filterpicker.selectfilter'"/>
    </webwork:if>
    <webwork:else>
        <webwork:text name="'popups.filterpicker.changefilter'"/>
    </webwork:else>
</a>
