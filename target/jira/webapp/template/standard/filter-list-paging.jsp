...
<webwork:if test="parameters['filterList'] != null && parameters['filterList']/size > 0 && parameters['paging'] != null && parameters['paging'] == true">
    <webwork:if test="parameters['pagingNextUrl'] != null || parameters['pagingPrevUrl'] != null">
        <div class="jiraCenteredContent filterPaging" style="text-align:center;position:relative;padding:5px 0px;">
